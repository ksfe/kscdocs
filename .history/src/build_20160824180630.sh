...
mkdir -p _assets/website/gitbook-plugin/
mkdir -p _assets/ebook/

# Compile JS
# browserify src/js/table.js | uglifyjs -mc > _assets/website/gitbook-plugin/table.js
cp src/js/code-copy.js  _assets/website/gitbook-plugin/code-copy.js
